...
# 결측치 대체 및 제거  / 대체하면 분석에 영향이 있을수 있으니 신중?
z1 <- c(1,2,3,NA,NA,8)
z2 <- c(5,8,1,NA,3,NA,7)
z1[is.na(z1)] <- 0     # NA를 0으로 대체/ is.na의 결과가TRUE인 요소만 0으로 바꾼다.
z1
z3 <- as.vector(na.omit(z2))    # NA를 제거하고 새로운 vector생성 
z3
